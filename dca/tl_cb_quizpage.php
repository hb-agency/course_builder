 ...
 */
$GLOBALS['TL_DCA']['tl_cb_quizpage'] = array
(
	// Config
	'config' => array
	(
		'dataContainer'               => 'Table',
		'ptable'                      => 'tl_cb_quiz',
		'ctable'                      => array('tl_cb_quizquestion'),
		'switchToEdit'                => true,
	...
	(
		...
		(
			...
			'child_record_callback'   => array('tl_cb_quizpage', 'compilePreview')
		),
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['edit'],
				'href'                => 'table=tl_cb_quizquestion',
				'icon'                => 'edit.gif',
				'button_callback'     => array('tl_cb_quizpage', 'editPage')
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['copy'],
				'href'                => 'act=paste&amp;mode=copy',
				'icon'                => 'copy.gif',
				'button_callback'     => array('tl_cb_quizpage', 'copyPage')
			),
			'cut' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['cut'],
				'href'                => 'act=paste&amp;mode=cut',
				'icon'                => 'cut.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();"',
				'button_callback'     => array('tl_cb_quizpage', 'cutPage')
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
				'attributes'          => 'onclick="if (!confirm(\'' . $GLOBALS['TL_LANG']['MSC']['deleteConfirm'] . '\')) return false; Backend.getScrollOffset();"',
				'button_callback'     => array('tl_cb_quizpage', 'deletePage')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	(
		'title' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['title'],
			'search'                  => true,
			'sorting'                 => true,
			'filter'                  => true,
			'flag'                    => 1,
		...
		'description' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['description'],
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'introduction' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['introduction'],
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'page_template' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_cb_quizpage']['page_template'],
			'default'                 => 'cb_quizpage_default',
			'inputType'               => 'select',
			'options_callback'        => array('tl_cb_quizpage', 'getSurveyTemplates'),
 ...
 * @package    Controller
 */
class tl_cb_quizpage extends Backend
{
	...
	{
		$objElements = $this->Database->prepare("SELECT * FROM tl_cb_quizpage WHERE (pid=? AND sorting < ?)")
			->execute($row["pid"], $row["sorting"]);
		$position = $objElements->numRows + 1;

		$template = new BackendTemplate('be_cb_page_preview');
		$template->page = $GLOBALS['TL_LANG']['tl_cb_quizpage']['page'];
