...
class FormQuizQuestionMultipleChoice extends FormQuizQuestion
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'form_quiz_multiplechoice';
	...
	public function __set($strKey, $varValue)
	{
		switch ($strKey)
		{
			case 'quizdata':
				...
				$arrChoices = deserialize($varValue['choices']);
				$this->arrChoices = $arrChoices['text'];
	...
	{
		$this->loadLanguageFile('tl_quiz_question');
		$template = new FrontendTemplate('quiz_question_multiplechoice');
