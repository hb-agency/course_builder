...
class ModuleCBCourseReader extends ModuleCB
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'mod_coursereader_default';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### COURSE BUILDER: COURSE READER ###';
	...
	{
		if($this->cb_coursereader_layout)
		{
			$this->Template = new FrontendTemplate($this->cb_coursereader_layout);
		}
		...
		$this->Template->course = $this->CourseBuilder->Course ? $this->CourseBuilder->Course->generate($this->cb_course_template, $this) : '';
